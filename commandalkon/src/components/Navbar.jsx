    ...
    <nav className="bg-gray-800">
      <div className="flex items-center font-medium justify-around">
        <div className="z-50 p-5 md:w-auto w-full flex justify-between">
          ...
          <div className="text-3xl text-gray-400 md:hidden" onClick={() => setOpen(!open)}>
            <ion-icon name={`${open ? "close" : "menu"}`}></ion-icon>
          </div>
        </div>
        <ul className="md:flex hidden uppercase items-center gap-6">
          <li>
            <Link to="/platform" className="inline-block text-gray-300 hover:text-red-500 px-3 py-2 rounded-md duration-500 text-xs font-semibold">
              PLATFORM
            </Link>
          </li>
          <NavLinks />
          <li>
            <Link to="/" className="inline-block text-gray-300 hover:text-red-500 px-3 py-2 rounded-md duration-500 text-xs font-semibold">
              RESOURCES
            </Link>
            <Link to="/support" className="inline-block text-gray-300 hover:text-red-500 px-3 py-2 rounded-md duration-500 text-xs font-semibold">
              SUPPORT
            </Link>
            <Link to="/about" className="inline-block text-gray-300 hover:text-red-500 px-3 py-2 rounded-md duration-500 text-xs font-semibold">
              ABOUT
            </Link>
          </li>
        </ul>
        ...
        >
          <li>
            <Link to="/platform" className="inline-block text-black px-3 py-2 text-lg hover:text-red-500  rounded-md duration-500 font-semibold">
              PLATFORM
            </Link>
          </li>
          <NavLinks />
          <li>
          <Link to="/support" className="inline-block text-black px-3 py-2 text-lg hover:text-red-500  rounded-md duration-500 font-semibold">
              SUPPORT
            </Link>
          </li>
          <li>
          <Link to="/about" className="inline-block text-black px-3 py-2 text-lg hover:text-red-500  rounded-md duration-500 font-semibold">
              ABOUT
            </Link>
          </li>
          <li>
